...
public class Parser implements ParserConstants {
    ...
    public Parser(ModelCheckInputs modelCheckInputs) {
          this(modelCheckInputs.getModelStream(), null); // dunno what this call does exactly, but it's needed to avoid JavaCC throwing a null error. Compare to the autogenerated constructor in CtlValidator.java line 168
          kripke = modelCheckInputs.getKripke();
          this.model = modelCheckInputs.getModel();
    }
...
{if ("" != null) return f;}
  ...
  final public Set binaryPredicate(Set subject, Set states) throws ParseException, ParseException, IOException {Set predicate;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case AND:{
